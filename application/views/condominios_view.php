        ...
        <header id="header">
            ...
            <section >
                <div class="container">
                    <div class="center"> 
                        <br/>
                        <h2>Cadastro de Condomínios</h2>

                    </div> 

                    <?php echo form_open('condominios/inserir', 'id="form-condominios"'); ?>             
...
<br/><br/>
            ...
            <div  class="center">
                ...
                <?php foreach ($condominios as $condominio): ?>
                    <li>
                        <a title="Deletar" href="<?php echo base_url() . 'condominios/deletar/' . $condominio->condominioId; ?>" onclick="return confirm('Confirma a exclusão deste registro?')">
                            <img src="<?php echo base_url('assets/images/lixo.png'); ?>" />
                        </a>
                        <span> - </span>
                        <a title="Editar" href="<?php echo base_url() . 'condominios/editar/' . $condominio->condominioId; ?>"><?php echo $condominio->nome; ?></a>
