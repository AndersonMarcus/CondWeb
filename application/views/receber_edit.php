            ...
            <body>
                ...
                <section >
                    <div class="container">
                        ...
                        <?php echo form_open('receber/atualizar', 'id="form-receber"'); ?>             
                        <input type="hidden" name="idContasReceber" value="<?php echo $dados_contasReceber[0]->idContasReceber; ?>"/>
                        ...
                        <div class="form-group">
                            <div class="col-sm-5 col-sm-offset-1">
                                <div class="form-group"> 
                                    ...
                                    <input type="text" class="form-control" name="nome" value="<?php echo $dados_contasReceber[0]->nome; ?>"/>
                                    <div class="error"><?php echo form_error('nome'); ?></div></div>
                                <div class="form-group">
                                    <label for="valor">Valor:</label><br/>
                                    <input type="text" class="form-control" name="valor" value="<?php echo $dados_contasReceber[0]->valor; ?>"/>
                                    <div class="error"><?php echo form_error('valor'); ?></div></div>
                                <div class="form-group">
                                    <label for="valorQtd">Quantidade:</label><br/>
                                    <input type="text" class="form-control" name="valorQtd" value="<?php echo $dados_contasReceber[0]->valorQtd; ?>"/>
                                    <div class="error"><?php echo form_error('valorQtd'); ?></div></div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <label for="total">Total:</label><br/>
                                    <input  class="form-control" type="text" name="total" value="<?php echo $dados_contasReceber[0]->total; ?>"/>
                        ...
                        <div class="form-group">
                            <input type="submit" name="atualizar" value="Atualizar" class="btn btn-primary btn-lg" style="position: relative; left: 100px;"/>
                        </div>
