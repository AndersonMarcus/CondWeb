...
<section >
                <div class="container">
                    <div class="center"> 
                        <br/>
                        <h2>Cadastro de Apartamentos</h2>

                    </div> 

                    <?php echo form_open('apartamentos/inserir', 'id="form-apartamentos"'); ?>             
                    ...
                    <div class="form-group">
                        <input type="submit" name="cadastrar" value="Cadastrar" class="btn btn-primary btn-lg" style=" top: 100px; position: relative; left: 100px;"/>
                    </div></div>
                    </div>
                    <?php echo form_close(); ?>
            ...
            <div class="center">   
                  ...
                  <br/><br/><br/> <br/><br/>
                <h4>Apartamentos Cadastrados</h4>
            ...
            <div  class="center">
                ...
                <?php foreach ($apartamentos as $apartamento): ?>
                    <li>
                        <a title="Deletar" href="<?php echo base_url() . 'apartamentos/deletar/' . $apartamento->apartamentoId; ?>" onclick="return confirm('Confirma a exclusão deste registro?')">
                            <img src="<?php echo base_url('assets/images/lixo.png'); ?>" />
                        </a>
                        <span> - </span>
                        <a title="Editar" href="<?php echo base_url() . 'apartamentos/editar/' . $apartamento->apartamentoId; ?>"><?php echo $apartamento->numero; ?></a>
