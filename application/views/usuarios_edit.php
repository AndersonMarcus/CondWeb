            ...
            <body>
                ...
                <section >
                    <div class="container">
                        ...
                        <div class="form-group">
                            <div class="col-sm-5 col-sm-offset-1">
                                <div class="form-group"> 
                                    ...
                                    <input type="text" class="form-control" name="nome" value="<?php echo $dados_usuario[0]->nome; ?>"/>
                                    <div class="error"><?php echo form_error('nome'); ?></div></div>
                                <div class="form-group">
                                    <label for="email">E-mail:</label><br/>
                                    <input type="text" class="form-control" name="email" value="<?php echo $dados_usuario[0]->email; ?>"/>
                                    <div class="error"><?php echo form_error('email'); ?></div></div>
                                <div class="form-group">
                                    <label for="senha">Senha:</label><br/>
                                    <input type="password" class="form-control" name="senha" value="<?php echo $dados_usuario[0]->senha; ?>"/>
                        ...
                        <div class="form-group">
                            <input type="submit" name="atualizar" value="Atualizar" class="btn btn-primary btn-lg" style="position: relative; top:20px; left: 30px;"/>
                        </div> 
                    </div>
                    <?php echo form_close(); ?>
