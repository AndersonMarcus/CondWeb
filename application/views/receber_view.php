...
<html lang="pt-BR">
    <head>
        ...
        <title>Cadastro de Contas a Receber | CondWeb</title>
        ...
        <header id="header">
            ...
            <section >
                <div class="container">
                    <div class="center"> 
                        <br/>
                        <h2>Cadastro de Contas Receber</h2>

                    </div> 

                    <?php echo form_open('receber/inserir', 'id="form-receber"'); ?>             
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="condominios" id="condominios"  <?php echo set_value('RecebercondominioId'); ?>>
                                    <?= $options_condominios ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="apartamentos" id="apartamentos">
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div  class="center">
                ...
                <?php foreach ($receber as $contasReceber): ?>
                    <li>
                        <a title="Deletar" href="<?php echo base_url() . 'receber/deletar/' . $contasReceber->idContasReceber; ?>" onclick="return confirm('Confirma a exclusão deste registro?')">
                            <img src="<?php echo base_url('assets/images/lixo.png'); ?>" />
                        </a>
                        <span> - </span>
                        <a title="Editar" href="<?php echo base_url() . 'receber/editar/' . $contasReceber->idContasReceber; ?>"><?php echo $contasReceber->nome; ?></a>
