            ...
            <body>
                ...
                <section >
                    <div class="container">
                        ...
                        <?php echo form_open('pagar/atualizar', 'id="form-pagar"'); ?>             
                        <input type="hidden" name="idContasPagar" value="<?php echo $dados_pagar[0]->idContasPagar; ?>"/>
                        ...
                        <div class="form-group">
                            <div class="col-sm-5 col-sm-offset-1">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <input type="text" class="form-control" name="nome" value="<?php echo $dados_pagar[0]->nome; ?>"/>
                                    <div class="error"><?php echo form_error('nome'); ?></div></div>
                                <div class="form-group">
                                    <label for="valor">Valor:</label><br/>
                                    <input type="text" class="form-control" name="valor" value="<?php echo $dados_pagar[0]->valor; ?>"/>
                                    <div class="error"><?php echo form_error('valor'); ?></div></div></div>
                            <div class="col-sm-5"> 
                                <div class="form-group">
                                    <label for="valorQtd">Quantidade:</label><br/>
                                    <input type="text" class="form-control" name="valorQtd" value="<?php echo $dados_pagar[0]->valorQtd; ?>"/>
                                    <div class="error"><?php echo form_error('valorQtd'); ?></div></div>


                                <div class="form-group">
                                    <label for="total">Total:</label><br/>
                                    <input  class="form-control" type="text" name="total" value="<?php echo $dados_pagar[0]->total; ?>"/>
